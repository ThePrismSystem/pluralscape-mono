...
Pluralscape signs every outgoing webhook delivery with an HMAC-SHA256 signature so you can verify that the payload originated from Pluralscape and was not modified in transit.
