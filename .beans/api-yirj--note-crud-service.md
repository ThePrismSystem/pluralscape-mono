...
updated_at: 2026-03-25T14:27:05Z
parent: api-i16z
blocked_by:
  - api-ub5i
  - api-d0ej
...
Created `apps/api/src/services/note.service.ts` with createNote, getNote, listNotes, updateNote, deleteNote, archiveNote, restoreNote. Polymorphic author, cursor pagination (createdAt desc), OCC, entity-lifecycle reuse. 30 integration tests passing.
