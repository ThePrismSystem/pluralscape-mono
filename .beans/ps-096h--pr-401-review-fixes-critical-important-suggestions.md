...
updated_at: 2026-04-09T09:19:30Z
parent: ps-nrg4
---
...
- [ ] Commit 4: fix(api): enforce import-job state machine and seed checkpoint (C3, C4, S5)
- [ ] Commit 5: fix(api): runtime-validate jsonb and harden route validation (I1, I2, I4, S4)
- [ ] Commit 6: fix(api): make recordImportEntityRef idempotent under race (I3)
- [ ] Commit 7: test(api,db): cover import e2e, rls, and branch gaps (C5, C6, I10)
- [ ] Commit 8: chore(api): import route ordering and shared constants (I11, S8, S9)
