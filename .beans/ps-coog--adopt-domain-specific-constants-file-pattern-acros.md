...
updated_at: 2026-03-15T20:46:00Z
---
...
- [ ] Document the pattern in CLAUDE.md (Code Quality section)
- [ ] Document the pattern in CONTRIBUTING.md
- [ ] Audit existing packages for magic number violations and migrate to \*.constants.ts files
- [ ] Investigate eslint hints/suggestions to guide developers toward the pattern (e.g. custom rule or eslint-plugin-suggest)
