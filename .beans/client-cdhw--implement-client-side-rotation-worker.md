...
## Summary of Changes\n\nNew @pluralscape/rotation-worker package with RotationWorker class, chunk processor, and dual-key reader. Extended BucketKeyCache with versioned key methods.
