...
- **`members`**: id (UUID PK, NOT NULL), system_id (FK → systems, NOT NULL), version (integer, T3, NOT NULL, default 1 — for CRDT optimistic locking), archived (boolean, T3, NOT NULL, default false), archived_at (T3, nullable), created_at (T3, NOT NULL, default NOW()), updated_at (T3), encrypted_data (bytea/blob, T1, NOT NULL — name, pronouns, description, avatar ref, colors, tags, saturationLevel ({ kind: 'known', level: KnownSaturationLevel } | { kind: 'custom', value: string }), suppressFriendFrontNotification, boardMessageNotificationOnFront)
