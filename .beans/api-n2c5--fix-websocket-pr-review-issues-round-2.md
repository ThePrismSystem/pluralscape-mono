...
updated_at: 2026-03-19T20:53:47Z
parent: api-fh4u
---
...
- [ ] Commit 2: fix(api): close security vulnerabilities in auth and snapshot handling
- [ ] Commit 3: fix(sync): use per-document sequence counters and fix LRU eviction
