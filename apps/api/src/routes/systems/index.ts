...
import { importEntityRefsRoute } from "./import-entity-refs/index.js";
import { importJobRoutes } from "./import-jobs/index.js";
...
systemRoutes.route("/:systemId/import-jobs", importJobRoutes);
systemRoutes.route("/:systemId/import-entity-refs", importEntityRefsRoute);
