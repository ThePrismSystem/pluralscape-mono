...
systemRoutes.route("/:systemId/subsystems", subsystemRoutes);
systemRoutes.route("/:systemId/side-systems", sideSystemRoutes);
systemRoutes.route("/:systemId/layers", layerRoutes);
...
systemRoutes.route("/:systemId/structure-links", structureLinkRoutes);
