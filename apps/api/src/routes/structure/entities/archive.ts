...
import { archiveStructureEntity } from "../../../services/structure-entity.service.js";
...
archiveRoute.use("*", requireScopeMiddleware("write:structure"));
...
archiveRoute.post("/:entityId/archive", async (c) => {
  ...
  await archiveStructureEntity(db, systemId, entityId, auth, audit);
