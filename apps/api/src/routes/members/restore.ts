...
import { restoreMember } from "../../services/member.service.js";
...
restoreRoute.post("/:memberId/restore", async (c) => {
  ...
  const result = await restoreMember(db, systemId, memberId, auth, audit);
