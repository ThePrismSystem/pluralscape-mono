...
import { friendAssignmentRoutes } from "./friends/index.js";
...
bucketRoutes.route("/:bucketId/friends", friendAssignmentRoutes);
bucketRoutes.route("/:bucketId/export", exportRoutes);
