...
const { updatePollVote, deletePollVote, getPollResults, castVote, listVotes, parsePollVoteQuery } =
  await import("../../services/poll-vote.service.js");

// ── Fixtures ─────────────────────────────────────────────────────────

const SYSTEM_ID = "sys_test-system" as SystemId;
const POLL_ID = "pl_test-poll" as PollId;
const VOTE_ID = "pv_test-vote" as PollVoteId;
