...
const { restoreEntity } = await import("../../../../services/innerworld/entity/lifecycle.js");
...
describe("POST /systems/:id/innerworld/entities/:entityId/restore", () => {
  beforeEach(() => {
    vi.mocked(restoreEntity).mockReset();
  });
  afterEach(() => {
    vi.restoreAllMocks();
  });
  ...
  it("returns 404 when not found", async () => {
    ...
    vi.mocked(restoreEntity).mockRejectedValueOnce(
