...
- We evaluate contributions on code quality, not the tools used to write them
- Governance is transparent — major decisions are documented as ADRs
...
- **User data is never sold, shared, or monetized — ever**
- **Full data export available at all times** — your data belongs to you
- **Full data deletion available at all times** — the right to be forgotten is absolute
- **Fail-closed security** — if something breaks, it defaults to maximum privacy, not exposure
- **Self-hosting is a goal** — users who want full control over their data can run their own instance
...
- Low-bandwidth and low-spec device support — this app must work for everyone
- Multi-language support (i18n) from the architecture level
- The "Littles Safe Mode" is a core feature, not an add-on
...
- The app serves all plural systems — DID, OSDD, endogenic, and beyond
...
- The community is governed by a Code of Conduct with zero tolerance for bigotry, harassment, sexism, racism, transphobia, homophobia, ableism, or any form of discrimination
