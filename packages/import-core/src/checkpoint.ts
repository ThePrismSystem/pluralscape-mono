 ...
 * not source-specific collection names. Callers walking a dependency order
 * must translate to `ImportCollectionType` before invoking these helpers.
 */
 ...
 *
 * `firstEntityType` must be an `ImportCollectionType`.
 *
 * @example
