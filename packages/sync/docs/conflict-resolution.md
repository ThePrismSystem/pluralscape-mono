...
| `structure-entity-link`        | `lww-map`       | entityId, parentEntityId, sortOrder                                                                                                                  | Parent-child hierarchy between entities              |
| `structure-entity-member-link` | `lww-map`       | parentEntityId, memberId, sortOrder                                                                                                                  | Members placed under entities                        |
| `structure-entity-association` | `lww-map`       | sourceEntityId, targetEntityId                                                                                                                       | Many-to-many cross-type relationships                |
...
| `field-value`                  | `lww-map`       | value, updatedAt                                                                                                                                     | Polymorphic: memberId, structureEntityId, or groupId |
...
| Sort order normalization             | Any `sortOrder` change on groups, structure entity links, structure entity member links, board messages | Re-number ascending to eliminate ties                                     |
