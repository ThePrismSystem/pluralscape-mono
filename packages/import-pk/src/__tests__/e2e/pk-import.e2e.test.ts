/**
 * E2E tests for the PK import engine running against real JSON export files.
 *
 * File source tests exercise the full pipeline: file parsing, Zod validation,
 ...
 *
 * A placeholder live-API test suite is gated behind PK_TEST_LIVE_API=true
...
import { fixturePath, runFileImport } from "./e2e-helpers.js";

import type { FileImportResult } from "./e2e-helpers.js";
...
describe.skipIf(!hasMinimalFixture)("PK file source E2E -- minimal export", () => {
...
// ── File Source: Adversarial ────────────────────────────────────────

describe.skipIf(!hasAdversarialFixture)("PK file source E2E -- adversarial export", () => {
  let importResult: FileImportResult;
