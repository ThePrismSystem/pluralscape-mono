...
CREATE TABLE "check_in_records" (
	...
	"archived" boolean DEFAULT false NOT NULL,
	"archived_at" timestamptz,
	CONSTRAINT "check_in_records_idempotency_key_unique" UNIQUE("idempotency_key"),
...
CREATE TABLE "notes" (
	"id" varchar(50) PRIMARY KEY NOT NULL,
	"system_id" varchar(50) NOT NULL,
	"author_entity_type" varchar(50),
	"author_entity_id" varchar(50),
	"encrypted_data" "bytea" NOT NULL,
	"created_at" timestamptz NOT NULL,
	"updated_at" timestamptz NOT NULL,
	"version" integer DEFAULT 1 NOT NULL,
...
CREATE TABLE "system_structure_entity_links" (
	...
	"sort_order" integer NOT NULL,
	"created_at" timestamptz NOT NULL,
	CONSTRAINT "system_structure_entity_links_entity_parent_uniq" UNIQUE NULLS NOT DISTINCT("entity_id","parent_entity_id")
);
--> statement-breakpoint
CREATE TABLE "system_structure_entity_member_links" (
	...
	"sort_order" integer NOT NULL,
	"created_at" timestamptz NOT NULL,
	CONSTRAINT "system_structure_entity_member_links_member_parent_uniq" UNIQUE NULLS NOT DISTINCT("member_id","parent_entity_id")
);
--> statement-breakpoint
...
CREATE INDEX "biometric_tokens_unused_idx" ON "biometric_tokens" USING btree ("token_hash") WHERE used_at IS NULL;--> statement-breakpoint
...
CREATE INDEX "bucket_content_tags_system_entity_type_idx" ON "bucket_content_tags" USING btree ("system_id","entity_type");--> statement-breakpoint
...
CREATE INDEX "import_entity_refs_account_system_idx" ON "import_entity_refs" USING btree ("account_id","system_id");--> statement-breakpoint
...
CREATE INDEX "timer_configs_enabled_active_idx" ON "timer_configs" USING btree ("enabled") WHERE "timer_configs"."archived_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX "webhook_deliveries_pending_retry_idx" ON "webhook_deliveries" USING btree ("next_retry_at") WHERE "webhook_deliveries"."status" = 'pending';--> statement-breakpoint
