...
ALTER TABLE switches FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS switches_system_isolation ON switches;
CREATE POLICY switches_system_isolation ON switches USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);
...
ALTER TABLE subsystems FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS subsystems_system_isolation ON subsystems;
CREATE POLICY subsystems_system_isolation ON subsystems USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- side_systems
ALTER TABLE side_systems ENABLE ROW LEVEL SECURITY;
ALTER TABLE side_systems FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS side_systems_system_isolation ON side_systems;
CREATE POLICY side_systems_system_isolation ON side_systems USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- layers
ALTER TABLE layers ENABLE ROW LEVEL SECURITY;
ALTER TABLE layers FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS layers_system_isolation ON layers;
CREATE POLICY layers_system_isolation ON layers USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- subsystem_memberships
ALTER TABLE subsystem_memberships ENABLE ROW LEVEL SECURITY;
ALTER TABLE subsystem_memberships FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS subsystem_memberships_system_isolation ON subsystem_memberships;
CREATE POLICY subsystem_memberships_system_isolation ON subsystem_memberships USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- side_system_memberships
ALTER TABLE side_system_memberships ENABLE ROW LEVEL SECURITY;
ALTER TABLE side_system_memberships FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS side_system_memberships_system_isolation ON side_system_memberships;
CREATE POLICY side_system_memberships_system_isolation ON side_system_memberships USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- layer_memberships
ALTER TABLE layer_memberships ENABLE ROW LEVEL SECURITY;
ALTER TABLE layer_memberships FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS layer_memberships_system_isolation ON layer_memberships;
CREATE POLICY layer_memberships_system_isolation ON layer_memberships USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- subsystem_layer_links
ALTER TABLE subsystem_layer_links ENABLE ROW LEVEL SECURITY;
ALTER TABLE subsystem_layer_links FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS subsystem_layer_links_system_isolation ON subsystem_layer_links;
CREATE POLICY subsystem_layer_links_system_isolation ON subsystem_layer_links USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- subsystem_side_system_links
ALTER TABLE subsystem_side_system_links ENABLE ROW LEVEL SECURITY;
ALTER TABLE subsystem_side_system_links FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS subsystem_side_system_links_system_isolation ON subsystem_side_system_links;
CREATE POLICY subsystem_side_system_links_system_isolation ON subsystem_side_system_links USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);

-- side_system_layer_links
ALTER TABLE side_system_layer_links ENABLE ROW LEVEL SECURITY;
ALTER TABLE side_system_layer_links FORCE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS side_system_layer_links_system_isolation ON side_system_layer_links;
CREATE POLICY side_system_layer_links_system_isolation ON side_system_layer_links USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);
...
DROP POLICY IF EXISTS sync_queue_system_isolation ON sync_queue;
CREATE POLICY sync_queue_system_isolation ON sync_queue USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);
...
CREATE POLICY sync_conflicts_system_isolation ON sync_conflicts USING (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar) WITH CHECK (system_id = NULLIF(current_setting('app.current_system_id', true), '')::varchar);
