...
CREATE UNIQUE INDEX `account_purge_requests_pending_unique_idx` ON `account_purge_requests` (`account_id`) WHERE status = 'pending';--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `acknowledgements_system_id_idx` ON `acknowledgements` (`system_id`);--> statement-breakpoint
CREATE INDEX `acknowledgements_confirmed_idx` ON `acknowledgements` (`confirmed`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `board_messages_system_id_idx` ON `board_messages` (`system_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `bucket_content_tags_entity_idx` ON `bucket_content_tags` (`entity_type`,`entity_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `buckets_system_id_idx` ON `buckets` (`system_id`);--> statement-breakpoint
...
CREATE TABLE `channels` (
	...
	`archived_at` integer,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`parent_id`) REFERENCES `channels`(`id`) ON UPDATE no action ON DELETE set null,
...
CREATE TABLE `check_in_records` (
	...
	FOREIGN KEY (`responded_by_member_id`) REFERENCES `members`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `custom_fronts_system_id_idx` ON `custom_fronts` (`system_id`);--> statement-breakpoint
...
CREATE INDEX `friend_codes_system_id_idx` ON `friend_codes` (`system_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `friend_connections_system_status_idx` ON `friend_connections` (`system_id`,`status`);--> statement-breakpoint
CREATE INDEX `friend_connections_friend_system_id_idx` ON `friend_connections` (`friend_system_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `friend_connections_system_friend_uniq` ON `friend_connections` (`system_id`,`friend_system_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `friend_connections_id_system_id_unique` ON `friend_connections` (`id`,`system_id`);--> statement-breakpoint
CREATE TABLE `friend_notification_preferences` (
	...
	`updated_at` integer NOT NULL,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`friend_connection_id`,`system_id`) REFERENCES `friend_connections`(`id`,`system_id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE UNIQUE INDEX `friend_notification_prefs_system_id_friend_connection_id_idx` ON `friend_notification_preferences` (`system_id`,`friend_connection_id`);--> statement-breakpoint
...
CREATE TABLE `groups` (
	...
	`archived_at` integer,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`parent_group_id`) REFERENCES `groups`(`id`) ON UPDATE no action ON DELETE set null,
...
--> statement-breakpoint
CREATE INDEX `innerworld_entities_system_id_idx` ON `innerworld_entities` (`system_id`);--> statement-breakpoint
...
CREATE TABLE `innerworld_regions` (
	...
	`version` integer DEFAULT 1 NOT NULL,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`parent_region_id`) REFERENCES `innerworld_regions`(`id`) ON UPDATE no action ON DELETE set null,
...
--> statement-breakpoint
CREATE INDEX `layers_system_id_idx` ON `layers` (`system_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `member_photos_system_id_idx` ON `member_photos` (`system_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `members_system_id_idx` ON `members` (`system_id`);--> statement-breakpoint
CREATE INDEX `members_archived_idx` ON `members` (`archived`);--> statement-breakpoint
...
CREATE TABLE `pk_bridge_state` (
	...
	`version` integer DEFAULT 1 NOT NULL,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	CONSTRAINT "pk_bridge_state_sync_direction_check" CHECK("pk_bridge_state"."sync_direction" IS NULL OR "pk_bridge_state"."sync_direction" IN (?, ?, ?)),
	CONSTRAINT "pk_bridge_state_version_check" CHECK("pk_bridge_state"."version" >= 1)
);
--> statement-breakpoint
CREATE UNIQUE INDEX `pk_bridge_state_system_id_idx` ON `pk_bridge_state` (`system_id`);--> statement-breakpoint
...
CREATE INDEX `recovery_keys_revoked_at_idx` ON `recovery_keys` (`revoked_at`);--> statement-breakpoint
CREATE TABLE `relationships` (
	...
	`version` integer DEFAULT 1 NOT NULL,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`source_member_id`) REFERENCES `members`(`id`) ON UPDATE no action ON DELETE set null,
...
--> statement-breakpoint
CREATE INDEX `side_systems_system_id_idx` ON `side_systems` (`system_id`);--> statement-breakpoint
...
CREATE TABLE `subsystems` (
	...
	`version` integer DEFAULT 1 NOT NULL,
	FOREIGN KEY (`system_id`) REFERENCES `systems`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`parent_subsystem_id`) REFERENCES `subsystems`(`id`) ON UPDATE no action ON DELETE set null,
...
--> statement-breakpoint
CREATE INDEX `timer_configs_system_id_idx` ON `timer_configs` (`system_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `webhook_configs_system_id_idx` ON `webhook_configs` (`system_id`);--> statement-breakpoint
