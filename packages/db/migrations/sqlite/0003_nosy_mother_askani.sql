...
--> statement-breakpoint
INSERT INTO `__new_accounts`("id", "email_hash", "email_salt", "password_hash", "kdf_salt", "created_at", "updated_at", "version") SELECT "id", "email_hash", "email_salt", "password_hash", "kdf_salt", "created_at", "updated_at", "version" FROM `accounts`;--> statement-breakpoint
DROP TABLE `accounts`;--> statement-breakpoint
ALTER TABLE `__new_accounts` RENAME TO `accounts`;--> statement-breakpoint
CREATE UNIQUE INDEX `accounts_email_hash_idx` ON `accounts` (`email_hash`);--> statement-breakpoint
ALTER TABLE `sync_queue` ADD `seq` integer NOT NULL;--> statement-breakpoint
