...
CREATE INDEX `check_in_records_system_pending_idx` ON `check_in_records` (`system_id`,`scheduled_at`) WHERE "check_in_records"."responded_at" IS NULL AND "check_in_records"."dismissed" = 0;--> statement-breakpoint
...
CREATE INDEX `friend_codes_account_id_idx` ON `friend_codes` (`account_id`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `friend_connections_account_friend_uniq` ON `friend_connections` (`account_id`,`friend_account_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `friend_notification_prefs_account_id_friend_connection_id_idx` ON `friend_notification_preferences` (`account_id`,`friend_connection_id`);--> statement-breakpoint
...
CREATE INDEX `timer_configs_system_id_archived_idx` ON `timer_configs` (`system_id`,`archived`);--> statement-breakpoint
...
CREATE INDEX `webhook_configs_system_id_archived_idx` ON `webhook_configs` (`system_id`,`archived`);--> statement-breakpoint
