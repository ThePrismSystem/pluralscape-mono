...
CREATE TABLE `__new_acknowledgements` (
	...
	CONSTRAINT "acknowledgements_version_check" CHECK("__new_acknowledgements"."version" >= 1),
	CONSTRAINT "acknowledgements_archived_consistency_check" CHECK(("__new_acknowledgements"."archived" = true) = ("__new_acknowledgements"."archived_at" IS NOT NULL))
);
--> statement-breakpoint
INSERT INTO `__new_acknowledgements`("id", "system_id", "created_by_member_id", "confirmed", "encrypted_data", "created_at", "updated_at", "version", "archived", "archived_at") SELECT "id", "system_id", "created_by_member_id", "confirmed", "encrypted_data", "created_at", "updated_at", "version", "archived", "archived_at" FROM `acknowledgements`;--> statement-breakpoint
