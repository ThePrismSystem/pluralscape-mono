...
export const AUDIT_EVENT_TYPES = [
  ...
  "side-system.created",
  "side-system.updated",
  "side-system.archived",
  "side-system.restored",
  "side-system.deleted",
  "layer.created",
  "layer.updated",
  "layer.archived",
  ...
  "subsystem-membership.added",
  "subsystem-membership.removed",
  "side-system-membership.added",
  "side-system-membership.removed",
